...
public:
  ...
  Branch(GLfloat init_angle, GLfloat init_y_translation, GLfloat init_length_scale=1.0f, 
	 GLfloat x_pos=0.0f, GLfloat z_pos=0.0f, int strong_factor=1, bool init_leaf=false);
  Branch(GLfloat init_angle, GLfloat init_y_translation, Branch* init_parent, 
          GLfloat init_length_scale=1.0f, int strong_factor=1, bool init_leaf=false);
